...
const manifest = deserializeManifest({
  ...
  routes: [
    ...
    },
    {
      ...
      links: [],
      scripts: [
        { type: 'external', value: '/_astro/hoisted.DRIXHXSN.js' },
        {
          stage: 'head-inline',
          children:
            "window.va = window.va || function () { (window.vaq = window.vaq || []).push(arguments); };\n\t\tvar script = document.createElement('script');\n\t\tscript.defer = true;\n\t\tscript.src = '/_vercel/insights/script.js';\n\t\tvar head = document.querySelector('head');\n\t\thead.appendChild(script);\n\t",
    ...
    },
    {
      ...
      links: [],
      scripts: [
        { type: 'external', value: '/_astro/hoisted.D7K59etb.js' },
        {
          stage: 'head-inline',
          children:
            "window.va = window.va || function () { (window.vaq = window.vaq || []).push(arguments); };\n\t\tvar script = document.createElement('script');\n\t\tscript.defer = true;\n\t\tscript.src = '/_vercel/insights/script.js';\n\t\tvar head = document.querySelector('head');\n\t\thead.appendChild(script);\n\t",
  ...
  entryModules: {
    ...
    '/node_modules/astro/dist/assets/endpoint/generic.js':
      'chunks/pages/generic_BSsEp8u7.mjs',
    '/src/pages/portfolio.astro': 'chunks/pages/portfolio_CoLKmuF5.mjs',
    '/src/pages/work.astro': 'chunks/pages/work_wuEw6gM6.mjs',
    '\u0000@astrojs-manifest': 'manifest_CIYrkdJz.mjs',
    ...
    '\u0000@astro-page:node_modules/astro/dist/assets/endpoint/generic@_@js':
      'chunks/generic_DtCk41iV.mjs',
    '\u0000@astro-page:src/pages/404@_@astro': 'chunks/404_BMHp3Mqg.mjs',
    '\u0000@astro-page:src/pages/portfolio@_@astro':
      'chunks/portfolio_CUfCBk1C.mjs',
    '\u0000@astro-page:src/pages/work@_@astro': 'chunks/work_C8h04PAY.mjs',
    '\u0000@astro-page:src/pages/index@_@astro': 'chunks/index_Dt5LP2FM.mjs',
