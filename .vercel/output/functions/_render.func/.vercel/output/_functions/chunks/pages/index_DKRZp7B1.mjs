<<<<<<< HEAD:.vercel/output/functions/_render.func/.vercel/output/_functions/chunks/pages/index_DKRZp7B1.mjs
...
import {
  ...
  B as Button,
  $ as $$BaseLayout,
} from './404_4DlFmmhl.mjs'
import { jsx, jsxs } from 'react/jsx-runtime'
import * as React from 'react'
import { useState, useEffect } from 'react'
import { SquareArrowOutUpRight, Download } from 'lucide-react'
import moment from 'moment-timezone'
>>>>>>> refs/remotes/origin/main:.vercel/output/functions/_render.func/.vercel/output/_functions/chunks/pages/index_BPaQ15HY.mjs
...
const $$ContentCard = createComponent(
  ($$result, $$props, $$slots) => {
    const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots)
    Astro2.self = $$ContentCard
    const { title, body } = Astro2.props
  ...
  '/Users/hng/Documents/1C/astro-portfolio-main/src/components/ContentCard.astro',
  void 0,
)
>>>>>>> refs/remotes/origin/main:.vercel/output/functions/_render.func/.vercel/output/_functions/chunks/pages/index_BPaQ15HY.mjs
...
const $$Card = createComponent(
  ...
  '/Users/hng/Documents/1C/astro-portfolio-main/src/components/Card.astro',
  void 0,
)
>>>>>>> refs/remotes/origin/main:.vercel/output/functions/_render.func/.vercel/output/_functions/chunks/pages/index_BPaQ15HY.mjs

const $$IntroCard = createComponent(
  ($$result, $$props, $$slots) => {
    return renderTemplate`${renderComponent(
      $$result,
      'Card',
      $$Card,
      { colSpan: 'md:col-span-3', rowSpan: 'md:row-span-2' },
      {
        default: (
          $$result2,
        ) => renderTemplate` ${maybeRenderHead()}<div class="flex h-full w-full"> <div class="flex flex-col justify-between gap-4 md:max-h-[300px]"> <div class="flex h-full flex-col gap-4"> <h6 class="m-0 text-sm font-light text-gray-500">welcome</h6> <p class="m-0, pr-10 text-xl font-light">
Hi, I'm <b class="font-bold">Hung Nguyen</b>, a highly motivated and
  ...
  '/Users/hng/Documents/1C/astro-portfolio-main/src/components/sections/IntroCard.astro',
  void 0,
)
...
const $$TimeZoneCard = createComponent(
  ($$result, $$props, $$slots) => {
  ...
  '/Users/hng/Documents/1C/astro-portfolio-main/src/components/sections/TimeZoneCard.astro',
  void 0,
)

const $$ContactsCard = createComponent(
  ($$result, $$props, $$slots) => {
    return renderTemplate`${renderComponent(
      $$result,
      'Card',
      ...
      {},
      {
        default: (
          $$result2,
        ) => renderTemplate` ${maybeRenderHead()}<div class="h-full"> <header class="flex justify-start"> <h1 class="text-xl font-bold text-foreground">
...
GitHub
  ...
  '/Users/hng/Documents/1C/astro-portfolio-main/src/components/sections/ContactsCard.astro',
  void 0,
)

const $$CVCard = createComponent(
  ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      { title: 'CV' },
      {
        default: (
          $$result2,
        ) => renderTemplate` ${maybeRenderHead()}<div class="card-actions mt-2 flex w-full items-center justify-center"> <div class="row-span-1 mt-4 flex space-x-2"> <figure> <object${addAttribute(PDF, 'data')} type="application/pdf" width="100%"></object> </figure> <div class="mt-4 flex flex-col gap-2"> <p class="text-sm text-muted-foreground">
...
View and download my resume in German by clicking on the button below
  ...
  '/Users/hng/Documents/1C/astro-portfolio-main/src/components/sections/CVCard.astro',
  void 0,
)

const $$ExperienceCard = createComponent(
  ($$result, $$props, $$slots) => {
  ...
  '/Users/hng/Documents/1C/astro-portfolio-main/src/components/sections/ExperienceCard.astro',
  void 0,
)

const $$StudyCard = createComponent(
  ($$result, $$props, $$slots) => {
    return renderTemplate`${renderComponent(
      $$result,
      'Card',
      $$Card,
      { colSpan: 'md:col-span-2', rowSpan: 'md:row-span-1', title: 'Studies' },
      {
        default: (
          $$result2,
        ) => renderTemplate` ${maybeRenderHead()}<div class="mt-2 space-y-4"> ${STUDIES.slice(0, 3).map((study) => renderTemplate`<div> <h3 class="text-lg font-semibold"> ${study.institution}</h3> ${study.title} in ${study.link} <p class="text-sm text-gray-600">${study.date}</p> </div>`)},
</div> `,
      },
    )}`
  },
  '/Users/hng/Documents/1C/astro-portfolio-main/src/components/sections/StudyCard.astro',
  void 0,
)
...
>>>>>>> refs/remotes/origin/main:.vercel/output/functions/_render.func/.vercel/output/_functions/chunks/pages/index_BPaQ15HY.mjs
  ...
  '/Users/hng/Documents/1C/astro-portfolio-main/src/pages/index.astro',
  void 0,
)
